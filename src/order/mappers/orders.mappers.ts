...
export function mapToInsert(input: any): any {
  return {
...
export function mapOrderDetailToInsert(input: any): any {
  return {
...
export function mapOrdersByStatus(
  order,
  totalCount,
  tagName,
  paymentAmountSum,
...
export function mapOrdersByOpenStatus(order): any {
  return {
    ProductCode: order.orderDetails
      .map((detail) => detail.productCode)
...
export function mapGetOrders(order): any {
  return {
    IsPayed: order.isPayed,
    OrderNotes: order.orderNotes,
    BillingAddress1: order.billingAddress1,
...
export function mapGetOrdersCSV(order: any): any {
  return {
    ProductCode: order.orderDetails
      .map((detail) => detail.productCode)
      .join(','),
...
export function mapGetOrdersProductsCSV(order): any {
  return {
    ProductCode: order.orderDetails
      .map((detail) => detail.productCode)
      .join(','),
...
export function mapOrderDetails(detail): any {
  return {
    ...
    ExportControlClassificationNumber: detail.exportControlClassificationNumber,
...
export function mapGetOrder(order, notes, orderDetails): any {
  return {
    ...
    LastModified: order.lastModified ? new Date(order.lastModified) : undefined,
    ...
    TaxShipping:
      ...
      (order.salesTaxRate3 || 0),
    TotalTax:
      (order.salesTax1 || 0) + (order.salesTax2 || 0) + (order.salesTax3 || 0),
    CustomerID: order.customerId,
...
export function mapGetOrderBySerial(order) {
  return {
    OrderEntrySystem: order.orderEntrySystem || '',
    IsPayed: order.isPayed || false,
...
export function mapGetTrackShipping(
  tracking,
  orders,
  matchedOrderDetail,
  notes,
  ...
  return {
    ...
    OrderDate: orders[0].orderDate ? new Date(orders[0].orderDate) : undefined,
...
export function mapGetOpenOrdersByProductId(order) {
  return {
